...
import {HashRouter as Router, Route, olnk} from 'react-router-dom'

const Rules = () => {
  return (
    <div className='rules'>
      <h1 className='darules'>The Ten Commandments of Rules</h1>
      ...
      <ul className='spaceout'>
        ...
        <center><h1> We can and should create our own rules for ourselves. </h1></center>
      </ul>
    </div>
  )
}
